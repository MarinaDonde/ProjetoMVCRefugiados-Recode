...
namespace refugiados.Controllers
{
    public class LoginsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdLogin,Usuario,Senha")] Login login)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdLogin,Usuario,Senha")] Login login)
        {
            if (id != login.IdLogin)
            {
                return NotFound();
